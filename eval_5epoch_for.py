...
parser.add_argument('--trained_model',
                    default="F:/young/weights/ssd_SIXray_20191222_25000.pth", type=str,
...
parser.add_argument('--imagesetfile',
                    ...
                    default="F:/young/image_test_mark.txt", type=str,
...
annopath = os.path.join(args.SIXray_root, 'Anno_core_coreless_battery_sub_4000_3000', '%s.txt')
imgpath = os.path.join(args.SIXray_root, 'cut_Image_core_coreless_battery_sub_4000_3000', '%s.jpg')
...
def parse_rec(filename,imgpath):
    ...
    #print("imgpath: ", imgpath, flush='True')
...
def reset_args(EPOCH):
    ...
    #args.trained_model = "/home/young/workspace/ml-project/ssd.pytorch/weights/ssd_SIXray_20191212{:d}.pth".format(
    #    EPOCH)
    #saver_root = '/media/trs2/wuzhangjie/SSD/eval/Xray20190723/Attention/base_battery_core_coreless_bs8_V/'
    
    saver_root = 'F:/young/Attention/base_battery_core_coreless/'
...
if __name__ == '__main__':
    ...
    EPOCHS = [x for x in range(580, 680, 20)]
    print(EPOCHS)
    for EPOCH in EPOCHS:
        reset_args(EPOCH)
